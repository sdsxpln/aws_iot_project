...
#define AWS_IOT_MQTT_CLIENT_ID         "kbncc3220" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "kbncc3220" ///< Thing Name of the Shadow this device is associated with
